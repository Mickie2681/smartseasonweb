# Generated by Django 4.2.30 on 2026-04-22 09:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crop_type', models.CharField(choices=[('corn', 'Corn'), ('wheat', 'Wheat'), ('soybeans', 'Soybeans'), ('rice', 'Rice'), ('cotton', 'Cotton'), ('barley', 'Barley'), ('oats', 'Oats'), ('potatoes', 'Potatoes'), ('tomatoes', 'Tomatoes'), ('other', 'Other')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('field', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='updates', to='field.field')),
            ],
            options={
                'ordering': ['-created_at'],
            },
